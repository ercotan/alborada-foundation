            ...
            {modelPillars.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex cursor-pointer items-center gap-4 rounded-2xl border p-5 text-left transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d4af37] ${
                    active
