...
export const donationTiers: DonationTier[] = [
  {
    ...
    defaultAmount: 150,
    progressClass: "w-[78%]",
    goalLabel: "META: 15 BECEADOS",
    progressLabel: "78% FINANCIADO",
  },
  {
    id: "library",
    ...
    amountUnit: "USD único",
    defaultAmount: 500,
    progressClass: "w-[45%]",
    goalLabel: "META: 8,000 LIBROS",
    progressLabel: "45% COMPLETADO",
  },
  {
    id: "ailab",
    ...
    defaultAmount: 1000,
    progressClass: "w-[60%]",
    goalLabel: "META: CLÚSTER 4 GPU",
    progressLabel: "60% FINANCIADO",
  },
  {
    id: "residence",
    ...
    defaultAmount: 350,
    progressClass: "w-[90%]",
    goalLabel: "META: BIENESTAR COMPLETO",
    progressLabel: "90% FINANCIADO",
  },
  {
    id: "sustainability",
    ...
    defaultAmount: 200,
    progressClass: "w-[35%]",
    goalLabel: "META: 10 APICULTURAS",
    progressLabel: "35% COMPLETADO",
